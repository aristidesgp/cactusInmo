<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white py-8 container">
        <div class="grid grid-cols-5 gap-3">
            <div class="text-3xl font-semibold col-start-1 col-end-3 text-left">{{$property->name}}</div>
        ...
        <div class=" text-lg leading-none">Id: {{$property->id}}</div>
        <div class=" text-lg leading-none">Estado: {{$property->purposeStatus}}</div>
        <div id="main"></div>        
    </div>    
